...
<template>
    <div class="m-auto flex flex-col items-center gap-3 w-2/3 bg-darkest p-5 rounded-xl my-5">
        ...
        <p>
            ...
            <a target="_blank" href="https://docs.google.com/spreadsheets/d/1CC2esYy1qUmtMAwdrMtVq322qAGbunvTAD0qjOBCdCU/edit?usp=sharing">here</a>!
        </p>
